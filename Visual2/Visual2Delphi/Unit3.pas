...
begin
  ...
  DataModule4.Zkategori.SQL.Add('insert into kategori (name) values (:name)');
  DataModule4.Zkategori.ParamByName('name').AsString := edt1.Text;
...
begin
  ...
  begin
    SQL.Clear;
    SQL.Add('update kategori set name = :name where id = :id');
...
begin
  ...
  begin
    SQL.Clear;
    SQL.Add('delete from kategori where id = :id');
    ParamByName('id').AsString := a;
    ExecSQL;
